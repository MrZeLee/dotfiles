...
hyprctl -r --quiet --batch "dispatch setfloating address:$active_window; dispatch tagwindow +float address:$active_window; dispatch resizewindowpixel exact ${float_width} ${float_height}, address:$active_window; dispatch movewindowpixel exact ${float_x} ${float_y}, address:$active_window; dispatch pin address:$active_window"
